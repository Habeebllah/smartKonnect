...
class CustomUserCreationForm(UserCreationForm):
    ...
    Phone = forms.CharField(max_length = 11, min_length = 11,  widget=forms.TextInput(attrs={'class':'form-control', 'type':'number', 'autocomplete': 'off','pattern':'[0-9]+', 'title':'Enter numbers Only '}))
...
class CustomUserChangeForm(UserChangeForm):
     ...
     AccountNumber = forms.CharField(max_length = 15,  widget=forms.TextInput(attrs={'class':'form-control', 'type':'number', 'autocomplete': 'off','pattern':'[0-9]+', 'title':'Enter numbers Only '}))
...
class Airtime_fundingform(forms.ModelForm):
    ...
    #  mobile_number = forms.CharField(max_length = 11, min_length = 11)
     mobile_number = forms.CharField(max_length = 11, min_length = 11, required=True, widget=forms.TextInput(attrs={'class':'form-control', 'type':'number', 'autocomplete': 'off','pattern':'[0-9]+', 'title':'Enter numbers Only '}))
...
class Airtime_to_Data_tranfer_form(forms.ModelForm):
    #  mobile_number = forms.CharField(max_length = 11, min_length = 11,label ='Receive Number')
     mobile_number = forms.CharField(label ='Receive Number', max_length = 11, min_length = 11, required=True, widget=forms.TextInput(attrs={'class':'form-control', 'type':'number', 'autocomplete': 'off','pattern':'[0-9]+', 'title':'Enter numbers Only '}))
     Ported_number = forms.BooleanField(required=False,initial=False,label='Bypass number validator ')
...
class Billpaymentform(forms.ModelForm):
    Customer_Phone = forms.CharField(max_length = 11, min_length = 11,help_text="customer phone number",  widget=forms.TextInput(attrs={'class':'form-control', 'type':'number', 'autocomplete': 'off','pattern':'[0-9]+', 'title':'Enter numbers Only '}))
    class Meta:
        model = Billpayment
