    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('intro_message', models.TextField(blank=True, default='Refer people to yuniqtelecoms and earn N500 immediately the person upgrade his/her account to affiliate or topuser', null=True)),
                ...
                ('easyaccess_api_key', models.CharField(blank=True, help_text='Enter your APIKEY here if you are using easyaccess.com.ng', max_length=500, null=True)),
                ...
                ('Cable_provider', models.CharField(blank=True, choices=[('VTPASS', 'VTPASS'), ('RINGO', 'RINGO'), ('MSORG WEB', 'MSORG WEB'), ('SMS', 'SMS')], default='VTPASS', max_length=50, null=True)),
                ('Bill_provider', models.CharField(blank=True, choices=[('VTPASS', 'VTPASS'), ('RINGO', 'RINGO'), ('MSORG WEB', 'MSORG WEB')], default='VTPASS', max_length=50, null=True)),
                ...
                ('email_verification', models.BooleanField(choices=[(True, 'ENABLE'), (False, 'DISABLE')], default=False, max_length=50, verbose_name='Disable Transaction limit for unverified user')),
        ...
        migrations.AlterField(
            ...
            field=models.CharField(blank=True, choices=[('UWS', 'UWS'), ('QTopUp', 'QTopUp'), ('SIMHOST', 'USSD.SIMHOSTING'), ('MSORG_DEVELOPED_WEBSITE_2', 'MSORG Developed Website 2'), ('SIMHOST_NG', 'SIMHOSTNG.COM'), ('SMEIFY', 'SMEIFY'), ('SMS', 'SMS'), ('EMAIL', 'EMAIL'), ('MSORG_DEVELOPED_WEBSITE', 'MSORG Developed Website 1'), ('SMEPLUG', 'SMEPLUG'), ('MSORG_DEVELOPED_WEBSITE_3', 'MSORG Developed Website 3')], max_length=30, null=True),
        ),
    ]
